...
test("more than eggs but not peanuts", () => {equal(~message="more than eggs but not peanuts", list(5), [Eggs, Shellfish])})

test("lots of stuff", () => {equal(~message="lots of stuff", list(248), [Strawberries, Tomatoes, Chocolate, Pollen, Cats])})

test("everything", () => {equal(~message="everything", list(255), [Eggs, Peanuts, Shellfish, Strawberries, Tomatoes, Chocolate, Pollen, Cats])})

test("no allergen score parts", () => {equal(~message="no allergen score parts", list(509), [Eggs, Shellfish, Strawberries, Tomatoes, Chocolate, Pollen, Cats])})

test("no allergen score parts without highest valid score", () => {equal(~message="no allergen score parts without highest valid score", list(257), [Eggs])})
